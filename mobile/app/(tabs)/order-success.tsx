          ...
          <View style={styles.section}>
            ...
            <View style={[styles.card, { backgroundColor: t.surface, borderColor: t.border }]}>
              <View style={[styles.activeBanner, { backgroundColor: '#FEF3C7', borderColor: '#F59E0B' }]}>
                ...
                <View style={{ flex: 1 }}>
                  <Text style={styles.activeBannerTitle}>Sedang Dikemas</Text>
                  <Text style={styles.activeBannerSub}>Penjual memilihkan produk terbaik untukmu</Text>
                </View>
...
const styles = StyleSheet.create({
  ...
  activeBanner:      { flexDirection: 'row', alignItems: 'center', gap: 10, borderWidth: 1.5, borderRadius: 12, padding: 14, marginBottom: 16 },
  activeBannerIcon:  { width: 38, height: 38, borderRadius: 10, alignItems: 'center', justifyContent: 'center' },
  activeBannerTitle: { fontSize: 13, fontWeight: '700', color: '#92400E', marginBottom: 2 },
  activeBannerSub:   { fontSize: 12, color: '#B45309' },
  pulseDot:          { width: 10, height: 10, borderRadius: 5 },
  miniRow:           { flexDirection: 'row', alignItems: 'flex-start', gap: 10, marginBottom: 4 },
  miniDotCol:        { alignItems: 'center', width: 16, paddingTop: 3 },
